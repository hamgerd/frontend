              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>توضیحات کاملی درباره رویداد، هدف آن و مخاطبان آن بنویسید.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="number" min="1" placeholder="تعداد شرکت‌کنندگان" {...field} />
                      </FormControl>
                      <FormDescription>حداکثر تعداد شرکت‌کنندگان در رویداد را وارد کنید.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
