...
export default function OrganizationPage({ params }: { params: { id: string } }) {
  // In a real app, you would fetch the organization data based on params.id
  const organization = {
    id: params.id,
    ...
    <div className="container py-10">
      ...
      <div className="relative mb-8">
        ...
        <div className="absolute -bottom-12 right-8 h-24 w-24 rounded-full overflow-hidden border-4 border-background bg-background">
          <Image src={organization.logo || "/placeholder.svg"} alt={organization.name} fill className="object-cover" />
        </div>
      </div>
        ...
        <div className="md:col-span-2">
          ...
          <Tabs defaultValue="about">
            ...
            <TabsContent value="about" className="mt-6">
              <p className="mb-6 whitespace-pre-line">{organization.longDescription}</p>

              <h3 className="text-lg font-bold mb-2">آدرس</h3>
              <p className="mb-6">{organization.address}</p>
