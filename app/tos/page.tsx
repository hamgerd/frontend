    ...
    <div className="container py-10 mx-auto">
      <div className="mx-5">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-lg border border-gray-200 dark:border-zinc-800 p-6 md:p-10 max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-6">تعاریف و اصطلاحات به‌کار رفته</h2>
          ...
          <h2 className="text-2xl font-bold mb-6">شرایط و قوانین مربوط به برگزارکننده‌ها</h2>
          ...
          <h2 className="text-2xl font-bold mb-6">استرداد بلیت خریداری‌شده توسط خریداران</h2>
