    ...
    <DayPicker
      ...
      components={{
        Root: ({ className, rootRef, ...props }) => {
          return <div className={cn(className)} ref={rootRef} data-slot="calendar" {...props} />;
        },
      ...
      formatters={{
        formatMonthDropdown: date => date.toLocaleDateString("fa-IR", { month: "long" }),
        formatCaption: date => date.toLocaleDateString("fa-IR", { month: "long", year: "numeric" }),
        ...formatters,
      }}
